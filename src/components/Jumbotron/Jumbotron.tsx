...
const Jumbotron: NextPage = () => (
  <Container>
      <Grid.Container css={{
          "height": "500px", "backgroundImage": "url(https://littlevisuals.co/images/747.jpg)"}}>

        <Grid xs={12} sm={6} alignItems='center'>
            <Col css={{"width": "100%", "padding": "60px"}}>
              <Text className='text-transition-slider' aria-hidden="true" data-slick-index="0" tabIndex={-1} weight='extrabold' size={40} 
              css={{"textAlign": "left"}}>
              ...
              <Tooltip content='Temos uma especialista à sua disposição!' rounded placement='bottomStart' color='primary'>
                <Button size="md" shadow color="gradient" css={{"width": "100%", "marginTop": "10px"}}>Saiba mais</Button>
              </Tooltip>
          </Col>
        </Grid>
      </Grid.Container>
